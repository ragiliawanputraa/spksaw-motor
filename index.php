        ...
        <div id="app">
            ...
            <div id="main">
                ...
                <div class="page-heading">
                    <h3>Dashboard</h3>
                    <h5>WEBSITE SISTEM PENDUKUNG KEPUTUSAN UNTUK MEMILIH KENDARAAN RODA DUA UNTUK KEBUTUHAN SEHARI HARI</h5>
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <p class="card-text">
                                            Website ini dibuat dalam rangka memenuhi nilai UAS Sistem Pendukung Keputusan TI CCIT 4A.
                                            Website ini disusun oleh :
                                        </p>
                                        <ol type="1">
                                            <li>Muhammad Izhhar Farhan - 2207412021</i>
                                            <li>Ragiliawan Putra Rencana - 2207412013</i>
                                            <li>Gema Hafizh Maulidi - 2207412002</i>
                                            <li>Frendy Eka Styabudi - 2207412053</i>
                                        </ol>
                                    </div>
                                </div>
                            </div>
